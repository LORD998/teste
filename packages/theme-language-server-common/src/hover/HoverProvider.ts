...
export class HoverProvider {
  ...
  constructor(
    ...
    readonly getMetafieldDefinitions: (uri: string) => Promise<MetafieldDefinitionMap>,
  ) {
    const typeSystem = new TypeSystem(themeDocset, getSettingsSchemaForURI, getMetafieldDefinitions);
    this.providers = [
